...
Last updated: 2026-09-26 10:45 IST (day 2).
...
| 29 | v103: v101 matcher + rule tuned on the mock tune S1; test inference; **upload #3** | M1 | E2 | 11:00 | doing | Mock **0.9704** (+0.0027; singletons 0.952 → 0.978; rule τ 0.725 / rel 0.7 / single 0.775); plain val 0.9833. Finding: **candidate recall at mock density 0.9655** (val 0.9906): blocking loses 3.5 % of true pairs at test density → #47 moved up |
